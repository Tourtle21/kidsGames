...
function setBackground(type) {
  ...
  div.style.height = screenBottom + "px";
  div.style.width = screenRight + "px";
  div.style.position = "absolute";
  div.style.top = "0px";
  div.style.left = "0px";
  document.body.appendChild(div);
  document.getElementsByTagName("div")[document.getElementsByTagName("div").length - 1].style.background = type;
  document.getElementsByTagName("div")[document.getElementsByTagName("div").length - 1].style.backgroundSize = "100% 100%";
}
...
function moveObjects(name, direction, amount, number) {
  if (document.getElementsByClassName(name).length != 0 && number != undefined) {
    ...
    var itemTop = document.getElementsByClassName(name)[number].style.top
    var itemLeft = document.getElementsByClassName(name)[number].style.left
    if (direction == "down") {
      document.getElementsByClassName(name)[number].style.top = parseInt(itemTop.slice(0, -2)) + amount + "px";
    }
    if (direction == "up") {
      document.getElementsByClassName(name)[number].style.top = parseInt(itemTop.slice(0, -2)) - amount + "px";
    }
    if (direction == "left") {
      document.getElementsByClassName(name)[number].style.left = parseInt(itemLeft.slice(0, -2)) - amount + "px";
    }
    if (direction == "right") {
      document.getElementsByClassName(name)[number].style.left = parseInt(itemLeft.slice(0, -2)) + amount + "px";
    }
...
function characterWithCharacter(name1, name2) {
  ...
  secondTop = parseInt(document.getElementById(name2).style.top.slice(0, -2));
  secondLeft = parseInt(document.getElementById(name2).style.left.slice(0, -2));
  firstWidth = parseInt(document.getElementById(name1).style.width.slice(0, -2));
  secondWidth = parseInt(document.getElementById(name2).style.width.slice(0, -2));
  firstHeight = parseInt(document.getElementById(name1).style.height.slice(0, -2));
  secondHeight = parseInt(document.getElementById(name2).style.height.slice(0, -2));
